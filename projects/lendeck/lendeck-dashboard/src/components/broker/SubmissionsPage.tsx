...
import { PageWrapper } from '../ui/mobile-container';
  ...
  return (
    <PageWrapper>
      ...
      <div className="space-y-4 p-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold">Submissions List</h1>
          <p className="text-muted-foreground text-sm sm:text-base">Manage Your Submitted Deals and Offers</p>
        </div>
