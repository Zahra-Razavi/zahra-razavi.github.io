...
import { ArrowLeft, MessageSquare, Clock, FileText, DollarSign, Building, Calendar, Download, Upload, Eye, CheckCircle, XCircle, AlertTriangle, Phone, Mail, MoreHorizontal } from 'lucide-react';
