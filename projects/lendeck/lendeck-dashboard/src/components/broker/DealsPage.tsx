...
import { Plus, Search, Eye, Edit, Upload, FileText, Share, Shield, Send, MoreHorizontal } from 'lucide-react';
    ...
    <div className="space-y-4 sm:space-y-6 w-full max-w-full overflow-x-hidden">
      ...
      <Card>
        <div className="space-y-4 p-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold">Deals List</h1>
            <p className="text-muted-foreground text-sm sm:text-base">Manage Your Deal Files and Documentation</p>
          </div>
